...
public class ExcerptSearchActivity extends BaseActivity
{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		back = (ImageView) findViewById(R.id.excerpt_search_back);
		home = (ImageView) findViewById(R.id.excerpt_search_home);
		searchText = (EditText) findViewById(R.id.excerpt_search_text);
		search = (ImageView) findViewById(R.id.excerpt_search_search);
		clear = (ImageView) findViewById(R.id.excerpt_search_clear);
...
//		userInfo = dbManager.user_currentUser(); //获取当前登录用户
		...
		search.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				if (null != searchTextValue && !searchTextValue.equals("") && !searchTextValue.equals("搜索")) {
					pd = ProgressDialog.show(ExcerptSearchActivity.this, "", "正在查询......");
		...
		back.setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View v) {
				ExcerptSearchActivity.this.setResult(RESULT_OK, null);
		...
		home.setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View v) {
				startActivity(new Intent(ExcerptSearchActivity.this, MainActivity.class));
			}
		});
	}
	...
	public class SearchHandler extends Handler
	{
		...
		public void handleMessage(Message msg) {
			...
			if (0 != files.size()) {
				...
				intent.setClass(context, ExcerptActivity.class);
